...
import {
  fetchMyRecipeByEmail,
  fetchMyRecipeDetails,
} from '@/api/myRecipe/data';
...
export default async function ShoppingList() {
  ...
  const myRecipeDetails =
    myRecipe === null || !myRecipe.recipeIds.length
      ? []
  ...
  const ingredientsToBuy =
    ingredientsToBuyRecord === null ? [] : ingredientsToBuyRecord.ingredients;
