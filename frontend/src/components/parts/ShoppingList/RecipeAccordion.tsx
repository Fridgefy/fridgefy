...
const RecipeAccordion = ({
  ...
  return (
    <Accordion
      type="single"
      collapsible
      className="w-full bg-input rounded-lg border p-4 recipe-accordion"
      onClick={toggleOpen}
    >
      <AccordionItem value="item-1" className="border-none">
        ...
        <AccordionContent className="p-2">
          <div className="w-full flex justify-between gap-4">
            <div className="w-2/3 border-r pr-2 pt-2">
              <div
                className="break-words "
                dangerouslySetInnerHTML={{ __html: summary }}
              />
              <div>
                <h1 className="font-bold mt-4 text-primary text-xl recipe-shadow">
                  Instructions
                </h1>
            ...
            <div className="w-1/3 flex flex-col pl-3">
              ...
              <div>
                <div className="mb-4">
                  <p className="text-sm font-semibold mb-1 underline underline-offset-2">
                    Diets:
                  </p>
                  <ul className="list-inside">{renderList(diets)}</ul>
                </div>
                <div className="mb-4  ">
                  <p className="text-sm font-semibold mt-4 mb-1 underline underline-offset-2">
                    Intolerances:
                  </p>
                ...
                <div className="mb-2">
                  <p className="text-sm font-semibold mb-1 underline underline-offset-4">
                    Ingredients:
                  </p>
