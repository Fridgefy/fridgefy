...
import {
  createIngredientsToBuy,
  removeIngredientsToBuy,
  removeIngredientsToBuyBulk,
} from '@/api/ingredientToBuy/data';
import {
  addIngredientToFridge,
  removeIngredientFromFridge,
} from '@/api/fridge/data';
...
export function ShoppingListPage({
  ...
  const removeRecipe = async (recipeId: number) => {
    ...
    const ingredientsToRemove = myRecipe!.extendedIngredients.map(
      (ingredientDetail) => ingredientDetail.name
    );

    await removeIngredientsToBuyBulk({
      userEmail,
      ingredientNames: ingredientsToRemove,
    });
